...
def create_form(cur, window, content_frame, row, 
    ...
    if not record_data: 
        od_all_normal_button = tk.Button(od_frame, text="Todo normal", command=lambda var=od_all_normal: update_all_normal(var))
        od_all_normal_button.pack(side="left")

        oi_all_normal_button = tk.Button(oi_frame, text="Todo normal", command=lambda var=oi_all_normal: update_all_normal(var))
        oi_all_normal_button.pack(side="left")
    ...
    def on_save(): 
        if record_data: 
            ...
            reason_for_visit = reason_for_visit_entry.get("1.0", tk.END).strip() 
            ...
            eyelid_od_cmt = eyelid_od_comment.get("1.0", tk.END).strip()
            eyelid_oi_cmt = eyelid_oi_comment.get("1.0", tk.END).strip()
            conjunctiva_od = conjunctiva_od_var.get()
            conjunctiva_oi = conjunctiva_oi_var.get()
            conjunctiva_od_cmt = conjunctiva_od_comment.get("1.0", tk.END).strip()
            conjunctiva_oi_cmt = conjunctiva_oi_comment.get("1.0", tk.END).strip()
            cornea_od = cornea_od_var.get()
            cornea_oi = cornea_oi_var.get()
            cornea_od_cmt = cornea_od_comment.get("1.0", tk.END).strip()
            cornea_oi_cmt = cornea_oi_comment.get("1.0", tk.END).strip()
            iris_od = iris_od_var.get()
            iris_oi = iris_oi_var.get()
            iris_od_cmt = iris_od_comment.get("1.0", tk.END).strip()
            iris_oi_cmt = iris_oi_comment.get("1.0", tk.END).strip()
            pupil_od = pupil_od_var.get()
            pupil_oi = pupil_oi_var.get()
            pupil_od_cmt = pupil_od_comment.get("1.0", tk.END).strip()
            pupil_oi_cmt = pupil_oi_comment.get("1.0", tk.END).strip()
            lente_od = lente_od_var.get()
            lente_oi = lente_oi_var.get()
            lente_od_cmt = lente_od_comment.get("1.0", tk.END).strip()
            lente_oi_cmt = lente_oi_comment.get("1.0", tk.END).strip()
            cd_od = cd_od_entry.get().strip()
            cd_oi = cd_oi_entry.get().strip()
            nerve_od = nerve_od_var.get()
            nerve_oi = nerve_oi_var.get()
            nerve_od_cmt = nerve_od_comment.get("1.0", tk.END).strip()
            nerve_oi_cmt = nerve_oi_comment.get("1.0", tk.END).strip()
            macula_od = macula_od_var.get()
            macula_oi = macula_oi_var.get()
            macula_od_cmt = macula_od_comment.get("1.0", tk.END).strip()
            macula_oi_cmt = macula_oi_comment.get("1.0", tk.END).strip()
            vasculature_od = vasculature_od_var.get()
            vasculature_oi = vasculature_oi_var.get()
            vasculature_od_cmt = vasculature_od_comment.get("1.0", tk.END).strip()
            vasculature_oi_cmt = vasculature_oi_comment.get("1.0", tk.END).strip()
            periphery_od = periphery_od_var.get()
            periphery_oi = periphery_oi_var.get()
            periphery_od_cmt = periphery_od_comment.get("1.0", tk.END).strip()
            periphery_oi_cmt = periphery_oi_comment.get("1.0", tk.END).strip()
            vitreous_od = vitreous_od_var.get()
            vitreous_oi = vitreous_oi_var.get()
            vitreous_od_cmt = vitreous_od_comment.get("1.0", tk.END).strip()
            vitreous_oi_cmt = vitreous_oi_comment.get("1.0", tk.END).strip()

            dx_myopia = dx_myopia_var.get()
            dx_hyperopia = dx_hyperopia_var.get()
            dx_astigmatism = dx_astigmatism_var.get()
            dx_comment = dx_comments.get("1.0", tk.END).strip()
            tx_comment = tx_comments.get("1.0", tk.END).strip()

            doctor_firstname = doctor_firstname_entry.get().strip()
            doctor_lastname = doctor_lastname_entry.get().strip()
